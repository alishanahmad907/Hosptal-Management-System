...
const AppointmentForm = () => {
	...
	const departmentsArray = ["Pediatrics", "Orthopedics", "Cardiology", "Neurology", "Oncology", "Radiology", "Physical Therapy", "Dermatology", "ENT", "General"];

	const [doctors, setDoctors] = useState([]);
	useEffect(() => {
		const fetchDoctors = async () => {
			const { data } = await axios.get("https://hms-backend-deployment-y8nl.onrender.com/api/v1/user/doctors", { withCredentials: true });
    ...
    const handleAppointment = async (e) => {
        ...
        try {
          ...
          const { data } = await axios.post(
            "https://hms-backend-deployment-y8nl.onrender.com/api/v1/appointment/post",
            {
              firstName,
              lastName,
              email,
